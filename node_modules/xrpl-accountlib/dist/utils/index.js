...
var hash_prefixes_1 = require("ripple-binary-codec/dist/hash-prefixes");
var hashes_1 = require("ripple-binary-codec/dist/hashes");
...
function encodeTransaction(TxJson, MultiSignAccount, definitions) {
    ...
    if (typeof MultiSignAccount !== "undefined") {
        ...
        return (0, ripple_binary_codec_1.encodeForMultisigning)(Transaction, MultiSignAccount, definitions);
    }
        ...
        if (!(Transaction === null || Transaction === void 0 ? void 0 : Transaction.TransactionType) &&
            ...
            return (0, ripple_binary_codec_1.encodeForSigningClaim)({
        ...
        // Regular TX signing
        return (0, ripple_binary_codec_1.encodeForSigning)(Transaction, definitions);
    }
    else {
        // Signed TX (tx_blob)
        return (0, ripple_binary_codec_1.encode)(Transaction, definitions);
    }
}
...
function combine(multiSignedTxHex, definitions) {
    ...
    var multiSignedTx = multiSignedTxHex.map(function (encoded) {
        return (0, ripple_binary_codec_1.decode)(encoded, definitions);
    });
    ...
    var signedTransaction = (0, ripple_binary_codec_1.encode)(__assign(__assign({}, multiSignedTx[0]), { Signers: sortedSigners }), definitions);
    return {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_e) {
            switch (_e.label) {
                ...
                case 2:
                    amendments = (_b = (_a = (_e.sent())) === null || _a === void 0 ? void 0 : _a.node) === null || _b === void 0 ? void 0 : _b.Amendments;
                    ...
                    ledgerSequence = Number(((_d = (_c = ledger === null || ledger === void 0 ? void 0 : ledger.closed) === null || _c === void 0 ? void 0 : _c.ledger) === null || _d === void 0 ? void 0 : _d.seqNum) || 0);
                    return [2 /*return*/, {
                            endpoint: endpoint,
                            networkId: networkId,
                        ...
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    ...
                                    _a = ripple_binary_codec_1.XrplDefinitions.bind;
                                    return [4 /*yield*/, (connection === null || connection === void 0 ? void 0 : connection.definitions())];
                                case 1:
                                    definitions = new (_a.apply(ripple_binary_codec_1.XrplDefinitions, [void 0, (_c.sent())]))();
                                ...
                                case 2:
                                    fee = _c.sent();
                                    return [2 /*return*/, ((_b = fee === null || fee === void 0 ? void 0 : fee.drops) === null || _b === void 0 ? void 0 : _b.base_fee) || null];
                            }
                        });
                    }); };
